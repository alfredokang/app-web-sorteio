...
export default function PageSorteio() {
  ...
  const [isDrawPossible, setIsDrawPossible] = useState<boolean | null>(null);
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden">
      ...
      {isDrawPossible == null ? (
        <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center px-6">
          <div className="mb-5">
            <Image
              src="/images/logo.png"
              alt="SortZapp"
          ...
          <div role="status" className="flex items-center">
            ...
            <span className="ml-2">Carregando a plataforma...</span>
          </div>
        </main>
      ) : (
