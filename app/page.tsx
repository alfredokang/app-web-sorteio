  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden">
      <button
        ...
        className="fixed right-6 top-6 z-40 rounded-full border border-white/10 bg-black/30 px-4 py-2 text-xs font-medium uppercase tracking-[0.3em] text-white/70 backdrop-blur transition hover:bg-black/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
      >
        Sair
      </button>
